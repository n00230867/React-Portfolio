        ...
        <footer className="py-12 sm:py-16 border-t border-border">
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6 sm:gap-8">
            <div className="space-y-3">
              <div className="text-sm text-muted-foreground">© 2025 Eduards Oss. All rights reserved.</div>
              <div className="text-sm text-muted-foreground">Building interfaces that feel intentional, fast, and delightful.</div>
            </div>
